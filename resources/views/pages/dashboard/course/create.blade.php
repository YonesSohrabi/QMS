                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-left">
                            ...
                            <li class="breadcrumb-item active">ایجاد دوره جدید</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-12">
                        <div class="card card-warning">
                            <div class="card-header">
                                <h3 class="card-title">شروع دوره جدید</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <form action="{{ route('courses.store') }}" method="post" role="form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control" placeholder="نام دوره مورد نظر را وارد کنید ...">
                                    </div>
